...
public class GroundingVm {
    ...
    private String id;
    private String shangjiacunwei;

    public String getShangjiacunwei() {
        return shangjiacunwei;
    }

    public void setShangjiacunwei(String shangjiacunwei) {
        this.shangjiacunwei = shangjiacunwei;
    }
